...
SECRET_KEY = '+8qxf+#-e$i*uhycom!z@5an22ditcj0f-d9!bl_@i2mdy)y#s'
...
INSTALLED_APPS = [
    ...
    'users.apps.UsersConfig',  # add class from apps.py from users to enable django to see and use created templates
    'crispy_forms',
